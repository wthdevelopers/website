  ...
  data:()=> {
    return {
      faqs: {
        ...
        faq1: ['What is <b><i>Immersive Realities</i></b>?', 'An umbrella term we use to describe <a href="https://en.wikipedia.org/wiki/Extended_reality" target="_blank">Extended Realities</a>, while including any other realities you want to define!'],
        faq2: ['Who can join this hackathon?', 'This competition is open to anybody 13 years old and above as at the date of the competition. Anyone below 18 years old will require his/her parent’s consent to participate in the competition. Please print out the <a href="https://tinyurl.com/wth-form" target="_blank">consent and indemnity form</a> for your parent’s signature and bring it on the day of the competition.'],
        faq3: ["I'm below 18. Where can I find the indemnity form?", "Participants below the age of 18 will need their parent’s consent to participate in the competition. Thus, they will need to submit the consent and indemnity form signed by their parent/guardian at the registration counter on the day of the competition. For all other participants, we will provide the forms for your signature at the registration counter on the day of the competition itself! You can download the indemnity form from <a href='https://tinyurl.com/wth-form' target='_blank'> here</a>."],
        ...
        faq8: ['How do we handle Intellectual Property (IP)?', 'Please refer to the Terms and Conditions of the Competition with regards to IP. You can download the Terms and Conditions <a href="https://tinyurl.com/wthtc" target="_blank"> here.'],
